...
<script>
  ...
  <section class="write-section">
    <div class="write-container">
     ...
     <form id="writeForm" class="write-form" method="post" action="/board/edit.do" enctype="multipart/form-data">
         ...
         <div class="form-group">
             ...
             <input type="text" name="boardTitle" class="form-input" value="${post.boardTitle}" required>
         </div>

         <div class="form-group">
             <label class="form-label required">내용</label>
             <textarea name="boardContent" class="form-textarea" required>${post.boardContent}</textarea>
         </div>
